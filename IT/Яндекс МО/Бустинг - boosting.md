- это принцип [[машинное обучение|машинного обучения]], в котором создаётся поочерёдно несколько [[модель ии|моделей]] и каждая последующая обучается на ошибках предыдущей
- В [[Случайный лес|случайном лесе]] модели обучаются независимо, а при бустинге — улучшают результаты друг друга

Напишем программу, которая решает уже знакомую нам задачу по выбору машины — но теперь с бустингом. Подготовим данные: [[Pandas]] [[numpy]] [[sklearn]]
...
```
Обучим обычное [[дерево в информатике|дерево]], чтобы сравнить [[точность модели|точность]] результата:
...
```
И перейдем к реализации адаптивного бустинга. Сначала мы создадим простую модель дерева, а потом будем улучшать ее множество раз, находя и исправляя ошибки:
...
Точность бустинга: 0.9976905311778291
```